...
if __name__ == "__main__":
    ...
    #from IPython import embed
    #embed()
      if(file_name.split('_')[1]!="MarioGANBC"):
          continue
      if(file_name.split('_')[3]!="elites"):
          continue
      algorithm_name=file_name.split('_')[0]
      sim_num=file_name.split('_')[2]
    ...
    #embed()
      ...
      with sns.axes_style("white"):
        ...
        g.set(xticks = [0,160])
        g.set(xticklabels = ['0','160'])
        g.set(yticks = [0,25])
        g.set(yticklabels = ['0','25'])
...
#        plt.xticklabels=['0','4.17'], 
        ...
        plt.show()
        fig.savefig(save_dir+'/'+algorithm_name+'_MarioGANBC_map_'+sim_num+'.pdf')
