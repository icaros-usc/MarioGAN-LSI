                ...
                for i,one_map in enumerate(all_records):
                    if i == 499:
                        ...
                        for data_point in one_map: 
                            ...
                            if  2.17*bc_1 +  bc_2> max_BC and fitness == 1.0:               
                              max_BC =  2.17*bc_1 + bc_2 
                           # if -bc_1  - bc_2 >  max_BC and fitness == 1.0:               
                            #  max_BC = -bc_1 - bc_2
...
if __name__ == "__main__":
    ...
    data_root = str("test_file/test_map")
    ...
    data_root = str("test_file/test_sim")

    all_simulations_name = "CMAME_" + str(domain) + "BC_sim2_all_simulations.csv"
